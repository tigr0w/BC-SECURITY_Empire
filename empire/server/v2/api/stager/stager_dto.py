...
from empire.server.v2.api.shared_dto import CustomOptionSchema, to_value_type, domain_to_dto_download_description, \
    DownloadDescription
...
def domain_to_dto_stager(stager: models.Stager):
    return Stager(
        ...
        downloads=list(map(lambda x: domain_to_dto_download_description(x), stager.downloads)),
