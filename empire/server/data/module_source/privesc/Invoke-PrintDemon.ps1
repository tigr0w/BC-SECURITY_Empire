...
<#
    .SYNOPSIS
        ...
        @ionescu007 PoC. The module prints a dll named ualapi.dll which is loaded
        to System32. The mdoule then places a launcher in the registry which executes code
        as system on restart.
...
'[+] Print Job Started on {0}' -f $PrinterName
