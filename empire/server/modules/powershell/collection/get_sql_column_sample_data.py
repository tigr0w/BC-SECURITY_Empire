...
class Module(object):
    ...
    def generate(main_menu, module: PydanticModule, params: Dict, obfuscate: bool = False, obfuscation_command: str = ""):
        ...
        script, err = main_menu.modules.get_module_source(module_name="collection/Get-SQLColumnSampleData.ps1", obfuscate=obfuscate, obfuscate_command=obfuscation_command)

        if check_all:
            aux_module_source = main_menu.modules.get_module_source(module_name="situational_awareness/network/Get-SQLInstanceDomain.ps1", obfuscate=obfuscate, obfuscate_command=obfuscation_command)
            if obfuscate:
