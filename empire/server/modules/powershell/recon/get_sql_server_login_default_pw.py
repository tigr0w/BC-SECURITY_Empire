...
class Module(object):
    ...
    def generate(main_menu, module: PydanticModule, params: Dict, obfuscate: bool = False, obfuscation_command: str = ""):
        ...
        if check_all:
            ...
            script, err = main_menu.modules.get_module_source(module_name="recon/Get-SQLInstanceDomain.ps1", obfuscate=obfuscate, obfuscate_command=obfuscation_command)
        ...
        if instance != "" and not check_all:
            # read in the common module source code
            script, err = main_menu.modules.get_module_source(module_name="recon/Get-SQLServerLoginDefaultPw.ps1", obfuscate=obfuscate, obfuscate_command=obfuscation_command)
