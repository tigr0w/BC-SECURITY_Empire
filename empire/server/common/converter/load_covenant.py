...
def _convert_covenant_to_empire(covenant_dict: Dict, file_path: str):
    empire_yaml = {
        ...
        'options': _convert_covenant_options_to_empire(covenant_dict['Options'], covenant_dict.get('Empire', {}).get('options', []), covenant_dict['CompatibleDotNetVersions']),
...
def _convert_covenant_options_to_empire(covenant_options: List[Dict], empire_options: List[Dict], compatible_versions: List[str]):
    empire_options.append({'name': 'Agent',
                       'value': '',
                       'description': 'Agent to run module on.',
                       'required': True,
                       'suggested_values': []
                       })
    empire_options.append({'name': 'DotNetVersion',
