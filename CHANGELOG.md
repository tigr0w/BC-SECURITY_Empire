...
- v2 API
- Autogenerated docs for the api
- pydispatcher removed
- new database table for files - stager files, files downloaded from agents, etc
- Restructuring of all the 'common' code
...
- hooks now get db session
- there is no longer a prompt on the server
- reporting is now a plugin
